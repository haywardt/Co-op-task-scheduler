...
### Example 3: One-Shot Delay with AFTER
    ...
    void runScheduler() {
        ...
        if (buttonPressed && !lastButtonState) {
            ...
            // Schedule turning it off once after 1 second - no flag needed!
            AFTER(1 SECONDS, []() {
                digitalWrite(LED_PIN, LOW);
                Serial.println("LED turned off after 1 second");
            });
        }
...
### scheduler.h
    ...
    // Main scheduler loop
    inline void scheduler_run(void (*scheduler_func)()) {
        BUSY_LED_ON();
        scheduler_func();
        BUSY_LED_OFF();
    }
...
**Happy Scheduling! 🚀**        digitalWrite(LED3_PIN, !digitalRead(LED3_PIN));
    }
